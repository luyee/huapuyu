...
public abstract class SqlSessionDaoSupport implements InitializingBean {
	...
	public final void afterPropertiesSet() throws Exception {
		...
		Map<String, DataSource> shardDataSources = sqlSessionFactoryBean
				.getShardDataSources();
		if (shardDataSources != null) {
			for (Entry<String, DataSource> entry : shardDataSources.entrySet()) {
				SqlSessionFactory sqlSessionFactory = sqlSessionFactoryBean
						.getShardSqlSessionFactory().get(entry.getKey());
		...
		public Object invoke(Object proxy, Method method, Object[] args)
			...
			try {
				...
				Configuration configuration = sqlSessionFactoryBean
						.getMainSqlSessionFactory().getConfiguration();
				...
				shardStrategy.setMainDataSource(sqlSessionFactoryBean
						.getMainDataSource());
				shardStrategy.setShardDataSources(sqlSessionFactoryBean
						.getShardDataSources());
