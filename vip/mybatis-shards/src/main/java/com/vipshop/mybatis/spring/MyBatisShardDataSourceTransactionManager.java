...
public class MyBatisShardDataSourceTransactionManager extends AbstractPlatformTransactionManager
	...
	private Class<?> oldAdviceClass = TransactionInterceptor.class;
	...
	public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
		...
		if (names != null) {
			for (String name : names) {
				...
				if (beanDef != null) {
					if (oldAdviceClass.getName().equals(beanDef.getBeanClassName())) {
						logger.warn("advice " + oldAdviceClass + " is replaced by " + newAdviceClass);
	...
	public DataSource getDataSource() {
		DataSource dataSource = TransactionHolder.getDataSource(); 
