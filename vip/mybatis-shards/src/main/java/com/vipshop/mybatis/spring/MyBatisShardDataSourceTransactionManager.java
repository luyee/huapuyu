...
public class MyBatisShardDataSourceTransactionManager extends AbstractPlatformTransactionManager implements ResourceTransactionManager, InitializingBean, BeanFactoryPostProcessor {
	...
	public Object doGetTransaction() {
		...
		ConnectionHolder conHolder = (ConnectionHolder) TransactionSynchronizationManager.getResource(TransactionHolder.getDataSource());
	...
	protected Object doSuspend(Object transaction) {
		...
		ConnectionHolder conHolder = (ConnectionHolder) TransactionSynchronizationManager.unbindResource(getThreadDataSource());
		return conHolder;
	}
