...
public class TransactionInterceptorExt extends TransactionAspectSupportExt implements MethodInterceptor, Serializable {
	 ...
	 */
	public TransactionInterceptorExt() {
	}
	 ...
	 * @see #setTransactionAttributes(java.util.Properties)
	 */
	public TransactionInterceptorExt(PlatformTransactionManager ptm, Properties attributes) {
	 ...
	 * @see #setTransactionAttributeSource(TransactionAttributeSource)
	 */
	public TransactionInterceptorExt(PlatformTransactionManager ptm, TransactionAttributeSource tas) {
		setTransactionManager(ptm);
