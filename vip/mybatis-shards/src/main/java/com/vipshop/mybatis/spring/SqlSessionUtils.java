...
/**
 * Handles MyBatis SqlSession life cycle. It can register and get SqlSessions from Spring {@code TransactionSynchronizationManager}. Also works if no transaction is active.
 * 
...
public final class SqlSessionUtils {
	...
	/**
	 * Checks if {@code SqlSession} passed as an argument is managed by Spring {@code TransactionSynchronizationManager} If it is not, it closes it, otherwise it just updates the reference counter and lets Spring call the close callback when the managed transaction ends
	 * 
	 * @param session
	 * @param sessionFactory
	 */
