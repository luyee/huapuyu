 ...
 */
public class MultiDataSourceTransactionManager extends
	...
	public Object doGetTransaction() {
		...
		ConnectionHolder conHolder = (ConnectionHolder) TransactionSynchronizationManager
				.getResource(TransactionHolder.getDataSource());
	...
	protected void doBegin(Object transaction, TransactionDefinition definition) {
		...
		try {
			...
			ReflectionUtils.invokeMethod(txObject.getConnectionHolder(),
					"setTransactionActive", new Class[] { boolean.class },
					new Object[] { true });
			...
			if (txObject.isNewConnectionHolder()) {
				TransactionSynchronizationManager.bindResource(
						getThreadDataSource(), txObject.getConnectionHolder());
			}
		}
	...
	protected void doResume(Object transaction, Object suspendedResources) {
		...
		TransactionSynchronizationManager.bindResource(getThreadDataSource(),
				conHolder);
	}
	...
	private static class DataSourceTransactionObject extends
		...
		public boolean hasTransaction() {
			return (getConnectionHolder() != null && getConnectionHolder()
					.getConnectionHandle() != null);
		}
