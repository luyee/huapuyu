 ...
 */
package com.anders.ssh.mock.easymock;
...
public class ConstructorCalledMockTest extends EasyMockSupport {
	...
	@Before
	public void setUp() {
		tc = createMockBuilder(TaxCalculator.class).withConstructor(BigDecimal[].class).withArgs((Object) new BigDecimal[] { new BigDecimal("5"), new BigDecimal("15") }) // varargs are special since they are in fact arrays
