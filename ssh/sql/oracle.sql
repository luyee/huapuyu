--创建表空间
CREATE TABLESPACE vote 
DATAFILE 'vote.DAT' SIZE 10M 
AUTOEXTEND 
ON NEXT 1M MAXSIZE UNLIMITED; 

--创建用户
CREATE USER vote PROFILE DEFAULT 
IDENTIFIED BY "123" DEFAULT TABLESPACE vote 
TEMPORARY TABLESPACE TEMP 
ACCOUNT UNLOCK;

--授权
GRANT CONNECT TO vote;

GRANT RESOURCE TO vote;
