...
"BEDROOM_COUNT" NUMBER(2,0) NOT NULL, 
"LIVING_ROOM_COUNT" NUMBER(2,0) NOT NULL, 
"KITCHEN_COUNT" NUMBER(2,0) NOT NULL, 
"WASHROOM_COUNT" NUMBER(2,0) NOT NULL, 
"BALCONY_COUNT" NUMBER(2,0) NOT NULL, 
"PROP_MGT_TYPE_ID" INTEGER, 
"DIRECTION_ID" INTEGER, 
"DECORATION_ID" INTEGER, 
"TOTAL_FLOOR" NUMBER(3,0), 
"FLOOR" NUMBER(3,0), 
...
COMMENT ON COLUMN "REMS"."TB_RENT_HOUSE"."TENANT_SEX_ID" IS '合租人性别要求编号（对应数据配置表类型13）';
