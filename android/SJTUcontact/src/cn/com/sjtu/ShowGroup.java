...
public class ShowGroup extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		SimpleCursorAdapter adapter = new SimpleCursorAdapter(this,
				...
				new String[] { ContactColumn.GROUP_NAME },
				new int[] { R.id.name });
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		if (0 == position) {
			...
			// ContentUris.withAppendedId(ContactsProvider.CONTENT_URI, id));
			Intent intent = new Intent(Intent.ACTION_GET_CONTENT, ContentUris
					.withAppendedId(GroupProvider.GROUP_URI, id));
