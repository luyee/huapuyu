...
public class CustomerServiceTest {
	...
	public void testFindById() {
		...
		Assert.assertEquals(1234, customer.getCustId().longValue());
		Assert.assertEquals("zhangsan", customer.getCustFullName());
		Assert.assertEquals("zhangsan", customer.getCustName());
		Assert.assertNull(customerService.findById(12345L));
	}
