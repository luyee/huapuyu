...
public class Request
		implements org.apache.thrift.TBase<Request, Request._Fields>,
	...
	static {
		...
		org.apache.thrift.meta_data.FieldMetaData
				.addStructMetaDataMap(Request.class, metaDataMap);
	}
	...
	public int compareTo(Request other) {
		...
		lastComparison = Boolean.valueOf(isSetAddress())
				.compareTo(other.isSetAddress());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetAddress()) {
			lastComparison = org.apache.thrift.TBaseHelper
					.compareTo(this.address, other.address);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
	...
	private static class RequestStandardScheme extends StandardScheme<Request> {
		...
		public void read(org.apache.thrift.protocol.TProtocol iprot,
				Request struct) throws org.apache.thrift.TException {
