        ...
        extends Expression
{
    ...
    {
        this(Optional.absent(), name, Optional.absent(),  Optional.absent(), false, arguments);
    }

    public FunctionCall(NodeLocation location, QualifiedName name, List<Expression> arguments)
    {
        this(Optional.of(location), name, Optional.absent(), Optional.absent(), false, arguments);
    }

    public FunctionCall(QualifiedName name, boolean distinct, List<Expression> arguments)
    {
        this(Optional.absent(), name, Optional.absent(), Optional.absent(), distinct, arguments);
    }

    public FunctionCall(NodeLocation location, QualifiedName name, boolean distinct, List<Expression> arguments)
    {
        this(Optional.of(location), name, Optional.absent(), Optional.absent(), distinct, arguments);
    }

    public FunctionCall(QualifiedName name, Optional<Window> window, boolean distinct, List<Expression> arguments)
    {
        this(Optional.absent(), name, window, Optional.absent(), distinct, arguments);
    }
    ...
    {
        this(Optional.absent(), name, window, filter, distinct, arguments);
    }
