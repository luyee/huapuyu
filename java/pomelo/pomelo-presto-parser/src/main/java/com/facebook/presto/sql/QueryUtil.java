...
public final class QueryUtil
{
    ...
    {
        return new SearchedCaseExpression(ImmutableList.of(new WhenClause(operand, result)), Optional.absent());
    }
    ...
    {
        return simpleQuery(select, from, Optional.absent(), ImmutableList.of());
    }

    public static Query simpleQuery(Select select, Relation from, List<SortItem> ordering)
    {
        return simpleQuery(select, from, Optional.absent(), ordering);
    }
    ...
    {
        return simpleQuery(select, from, where, Optional.absent(), Optional.absent(), ordering, Optional.absent());
    }
