        ...
        extends SqlBaseBaseVisitor<Node>
{
    ...
    {
        Optional<Relation> from = Optional.absent();
        ...
        if (!relations.isEmpty()) {
            ...
            while (iterator.hasNext()) {
                relation = new Join(getLocation(context), Join.Type.IMPLICIT, relation, iterator.next(), Optional.absent());
            }
    ...
    public Node visitJoinRelation(SqlBaseParser.JoinRelationContext context)
    {
        ...
        if (context.CROSS() != null) {
            ...
            return new Join(getLocation(context), Join.Type.CROSS, left, right, Optional.absent());
        }
    ...
    {
        Optional<String> comment = Optional.absent();
