        ...
        extends Expression
{
    ...
    {
        this(Optional.absent(), type, left, right);
    }
    ...
    {
        return new LogicalBinaryExpression(Optional.absent(), Type.AND, left, right);
    }

    public static LogicalBinaryExpression or(Expression left, Expression right)
    {
        return new LogicalBinaryExpression(Optional.absent(), Type.OR, left, right);
    }
