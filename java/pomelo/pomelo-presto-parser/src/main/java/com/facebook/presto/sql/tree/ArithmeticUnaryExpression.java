        ...
        extends Expression
{
    ...
    {
        this(Optional.absent(), sign, value);
    }
    ...
    {
        return new ArithmeticUnaryExpression(Optional.absent(), Sign.PLUS, value);
    }

    public static ArithmeticUnaryExpression negative(Expression value)
    {
        return new ArithmeticUnaryExpression(Optional.absent(), Sign.MINUS, value);
    }
