...
public class BooleanLiteral
        extends Literal
{
    public static final BooleanLiteral TRUE_LITERAL = new BooleanLiteral(Optional.absent(), "true");
    public static final BooleanLiteral FALSE_LITERAL = new BooleanLiteral(Optional.absent(), "false");

    private final boolean value;

    public BooleanLiteral(String value)
    {
        this(Optional.absent(), value);
    }
