// $ANTLR 2.7.7 (20060906): "sql.g" -> "SQLLexer.java"$
...
public SQLLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("delete", this), new Integer(5));
	literals.put(new ANTLRHashString("insert", this), new Integer(9));
	literals.put(new ANTLRHashString("select", this), new Integer(11));
	literals.put(new ANTLRHashString("update", this), new Integer(13));
	...
	literals.put(new ANTLRHashString("where", this), new Integer(14));
	literals.put(new ANTLRHashString("set", this), new Integer(12));
}
