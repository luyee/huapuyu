...
public class ZooKeeperNativeTest {
	...
	public void test() throws IOException, KeeperException, InterruptedException {
		...
		zk.create("/zk_test", "".getBytes(), Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);
		zk.create("/zk_test/logbacklevel", "debug".getBytes(), Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);
