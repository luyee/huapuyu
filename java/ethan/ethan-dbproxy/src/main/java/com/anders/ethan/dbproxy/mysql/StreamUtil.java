...
public class StreamUtil {
    ...
    public static final void write(ByteBuf out, byte b) throws IOException {
    ...
    public static final void writeUB2(ByteBuf out, int i) throws IOException {
        byte[] b = new byte[2];
        b[0] = (byte) (i & 0xff);
        b[1] = (byte) (i >>> 8);
        out.writeBytes(b);
    ...
    public static final void writeUB3(ByteBuf out, int i) throws IOException {
        byte[] b = new byte[3];
        b[0] = (byte) (i & 0xff);
        b[1] = (byte) (i >>> 8);
        b[2] = (byte) (i >>> 16);
    ...
    public static final void writeUB4(ByteBuf out, long l) throws IOException {
        byte[] b = new byte[4];
        b[0] = (byte) (l & 0xff);
        b[1] = (byte) (l >>> 8);
        b[2] = (byte) (l >>> 16);
    ...
    public static final void writeLong(ByteBuf out, long l) throws IOException {
        byte[] b = new byte[8];
        b[0] = (byte) (l & 0xff);
        b[1] = (byte) (l >>> 8);
        b[2] = (byte) (l >>> 16);
    ...
    public static final void writeWithNull(ByteBuf out, byte[] src) throws IOException {
        out.writeBytes(src);
    ...
    public static final void writeWithLength(ByteBuf out, byte[] src) throws IOException {
        int length = src.length;
        if (length < 251) {
