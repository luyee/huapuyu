...
import com.anders.ethan.log.dapper.client.common.JsonUtils;
...
public class LocalAsySendImpl {
	...
	private static Logger logger = LoggerFactory
			.getLogger(LocalAsySendImpl.class);

	private static Logger traceLogger = LoggerFactory
			.getLogger("mercury-trace-logger");

	private static Logger logLogger = LoggerFactory
			.getLogger("mercury-log-logger");

	private static Logger metricLogger = LoggerFactory
			.getLogger("mercury-metric-logger");
	...
	// int endIndex = (i+1) * sendLimit >=
	// logsCache.size()?logsCache.size():(i+1) * sendLimit;
