package com.anders.ethan.log.client.api.spi;
...
//    void sendMetricSpan(MetricSpan metricSpan);
    ...
    //构建rootSpan,是否采样
    Span newSpan(String appName, String spanName, Endpoint endpoint, String serviceId);

    //构建Span，参数通过上游接口传递过来
    Span genSpan(String appName, String traceId, String pid, String id, String spanName, boolean isSample, String serviceId, Endpoint endpoint);
    ...
    //构建cr annotation
    void clientReceiveRecord(Span span, Endpoint endpoint, long end, long duration);
