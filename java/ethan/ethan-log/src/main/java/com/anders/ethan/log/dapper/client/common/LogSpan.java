...
public class LogSpan implements Serializable {
	...
	public LogSpan() {
		this.logId = String
				.valueOf(UUID.randomUUID().getLeastSignificantBits());
	}
	...
	public String toString() {
		return "LogSpan{" + "app='" + app + '\'' + "ip='" + ip + '\''
				+ ", hostName='" + hostName + '\'' + ", instance='" + instance
				+ '\'' + ", level='" + level + '\'' + ", processId='"
				+ processId + '\'' + ", threadId='" + threadId + '\''
				+ ", logIdentity='" + logIdentity + '\'' + ", method='"
				+ method + '\'' + ", logDatail='" + logDatail + '\''
				+ ", eventType='" + eventType + '\'' + ", serviceId='"
				+ serviceId + '\'' + ", traceId='" + traceId + '\''
				+ ", spanId='" + spanId + '\'' + ", timestamp=" + timestamp
				+ ", isSample=" + isSample + ", logId='" + logId + '\''
				+ ", file='" + file + '\'' + '}';
	}
}
